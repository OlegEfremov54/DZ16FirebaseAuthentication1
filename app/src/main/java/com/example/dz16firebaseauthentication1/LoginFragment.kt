...
import com.example.dz16firebaseauthentication1.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //Вешаем слушателя на кнопку Войти
        binding.loginBtn.setOnClickListener {
            login()
        }
        //несуществующего Юзера отправляем на Регистрацию
